...
let seconds=5;
let answers=["hey there", "what's up", "how are you", "you okay", "how old are you"];
let n=0;
...
let ques2= new Change("#3","up what's");
let ques3= new Change("#4","how you are");
let ques4= new Change("#1","okay you");
let ques5= new Change("#2","old how are you");
    ...
    if(arr.length===0){
        ...
        switch(n){
            case 0: 
                ...
                document.getElementById("end").style.fontSize="130%";
                break;
